...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        gc.setAuthor("zwh");
        gc.setOutputDir("C:\\Users\\30560\\IdeaProjects\\test\\springboot-capture\\src\\main\\java");
        ...
        strategy.setInclude(new String[] { "case_of_court" }); // 需要生成的表
